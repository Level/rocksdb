...
bool Iterator::OutOfRange (rocksdb::Slice* target) {
  if (lt != NULL) {
...
NAN_METHOD(Iterator::Seek) {
  ...
  iterator->target = new rocksdb::Slice(_targetCh_, _targetSz_);
  ...
  if (info.Length() > 1 && info[2]->IsObject()) {
    ...
    if (optionsObj->Has(Nan::New("start").ToLocalChecked())
      ...
      if (StringOrBufferLength(startBuffer) > 0) {
        ...
        start = new rocksdb::Slice(_startCh_, _startSz_);
        startStr = _startCh_;
      }
    }
    ...
    if (optionsObj->Has(Nan::New("lt").ToLocalChecked())
      ...
      if (StringOrBufferLength(ltBuffer) > 0) {
        ...
        if (reverse) {
          ...
          if (start != NULL)
            delete start;
          start = new rocksdb::Slice(lt->data(), lt->size());
        }
      }
    }
    ...
    if (optionsObj->Has(Nan::New("lte").ToLocalChecked())
      ...
      if (StringOrBufferLength(lteBuffer) > 0) {
        ...
        if (reverse) {
          ...
          if (start != NULL)
            delete start;
          start = new rocksdb::Slice(lte->data(), lte->size());
        }
      }
    }
    ...
    if (optionsObj->Has(Nan::New("gt").ToLocalChecked())
      ...
      if (StringOrBufferLength(gtBuffer) > 0) {
        ...
        if (!reverse) {
          ...
          if (start != NULL)
            delete start;
          start = new rocksdb::Slice(gt->data(), gt->size());
        }
      }
    }
    ...
    if (optionsObj->Has(Nan::New("gte").ToLocalChecked())
      ...
      if (StringOrBufferLength(gteBuffer) > 0) {
        ...
        if (!reverse) {
          ...
          if (start != NULL)
            delete start;
          start = new rocksdb::Slice(gte->data(), gte->size());
        }
      }
    }
